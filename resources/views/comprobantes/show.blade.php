    ...
    <div class="container py-5">
        ...
        <div class="card border-dark shadow-sm p-4" id="invoice">
            ...
            <div class="row mb-4 border-bottom pb-3">
                <div class="col-8">
                    <h4 class="fw-bold text-uppercase">Mi Tienda de Gorras</h4>
                ...
                <div class="col-4 text-end">
                    ...
                    <p class="mb-0"><strong>Fecha:</strong>
                        {{ \Carbon\Carbon::parse($comprobante->COM_FECHA)->format('d/m/Y') }}</p>
                ...
                <div class="col-5">
                    <table class="table table-sm table-borderless">
                        ...
                        <tr class="border-top border-dark">
                            ...
                            <td class="text-end display-6 fw-bold">${{ number_format($comprobante->COM_TOTAL, 2) }}</td>
                        </tr>
                    </table>
                </div>
            </div>
