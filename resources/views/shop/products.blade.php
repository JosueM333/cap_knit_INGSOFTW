...
<body>
    ...
    <header class="sticky-top py-3 shadow-sm border-bottom border-secondary" role="banner">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('shop.index') }}" class="text-decoration-none fw-bold fs-4 d-flex align-items-center gap-2 text-white">
                        ...
                        <div class="card-body text-center d-flex flex-column p-4">
                            ...
                            <div class="mt-auto d-grid gap-2">
                                <a href="{{ route('add.to.cart', $producto->PRO_ID) }}" 
                                   ...
                                   aria-label="Añadir {{ $producto->PRO_NOMBRE }} al carrito">
                                   <i class="bi bi-cart-plus me-1"></i> Añadir
                                </a>
                                
                                <a href="{{ route('shop.show', $producto->PRO_ID) }}" 
                                   class="btn btn-dark fw-bold"
                                   aria-label="Ver detalles de {{ $producto->PRO_NOMBRE }}">
                                   Ver Detalle
                                </a>
                            </div>
                        </div>
    ...
    <footer class="py-5 mt-auto" role="contentinfo">
        <div class="container text-center text-md-start">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <a href="#main-content" class="text-white text-decoration-none fw-bold small opacity-75 hover-opacity-100">
