...
@section('content')
    <div class="container py-5 animate-entry">
        ...
        @if(session('success'))
            <div class="alert alert-success fw-bold border-2 border-success shadow-sm mb-4 no-print" role="alert">
        ...
        <div class="card border-dark shadow-lg p-5 bg-white" id="invoice-doc">
            ...
            <div class="row align-items-start mb-5">
                ...
                <div class="col-md-7">
                    ...
                    <div class="px-2">
                        <h4 class="fw-bold text-dark mb-1">{{ $comprobante->cliente->CLI_NOMBRES }} {{ $comprobante->cliente->CLI_APELLIDOS }}</h4>
                ...
                <div class="col-md-5 text-end">
                    <h6 class="text-uppercase text-muted fw-bold mb-3 small bg-light p-2 rounded">Detalles del Documento</h6>
                    <div class="px-2">
                        <div class="fs-4 fw-bold text-dark">FACTURA No. {{ str_pad($comprobante->COM_ID, 6, '0', STR_PAD_LEFT) }}</div>
                        <div class="text-muted">
                            <span class="fw-bold">Fecha de Emisión:</span> {{ \Carbon\Carbon::parse($comprobante->COM_FECHA)->format('d/m/Y') }}
                        </div>
                        <div class="mt-2">
