                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="{{ route('login') }}" id="loginForm" novalidate>
                            ...
                            <div class="mb-4 form-check">
                                <input type="checkbox" class="form-check-input border-dark" id="remember-me" name="remember" {{ old('remember') ? 'checked' : '' }}>
                        ...
                        <div class="text-center mt-4 pt-3 border-top border-light">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('shop.index') }}" class="text-decoration-none small text-muted fw-bold link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
