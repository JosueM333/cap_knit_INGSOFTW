                    ...
                    <form action="{{ route('productos.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="PRO_CODIGO"
                                    class="form-control @error('PRO_CODIGO') is-invalid @enderror"
                                    value="{{ old('PRO_CODIGO') }}" required>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="PRO_NOMBRE"
                                    class="form-control @error('PRO_NOMBRE') is-invalid @enderror"
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="PRO_DESCRIPCION"
                                    class="form-control @error('PRO_DESCRIPCION') is-invalid @enderror" rows="2"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" name="PRO_PRECIO"
                                    class="form-control @error('PRO_PRECIO') is-invalid @enderror"
                                    value="{{ old('PRO_PRECIO') }}" required>
                                @error('PRO_PRECIO') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">Marca</label>
                                <input type="text" name="PRO_MARCA"
                                    class="form-control @error('PRO_MARCA') is-invalid @enderror"
                                    value="{{ old('PRO_MARCA') }}">
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="PRO_COLOR"
                                    class="form-control @error('PRO_COLOR') is-invalid @enderror"
                                    value="{{ old('PRO_COLOR') }}">
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">Talla</label>
                                <input type="text" name="PRO_TALLA"
                                    class="form-control @error('PRO_TALLA') is-invalid @enderror"
                                    value="{{ old('PRO_TALLA') }}" placeholder="Ej: M, 40, XL">
                            </div>
                        </div>
