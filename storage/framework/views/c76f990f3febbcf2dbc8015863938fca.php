...
<body>
    ...
    <header class="u-bg-gray border-bottom border-2 sticky-top py-3 shadow-sm" role="banner">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('shop.index')); ?>" class="text-dark text-decoration-none fw-bold fs-4 d-flex align-items-center">
            ...
            <nav aria-label="Navegación principal">
                <ul class="d-flex gap-4 list-unstyled text-uppercase small mb-0 align-items-center fw-bold">
                    ...
                    <?php if(auth()->guard('cliente')->guest()): ?>
                        <li>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-dark btn-sm fw-bold">
                        ...
                        <li class="dropdown">
                            <a href="#" class="btn btn-dark btn-sm fw-bold dropdown-toggle" 
                               ...
                               aria-expanded="false">
                                ...
                                Hola, <?php echo e(Auth::guard('cliente')->user()->CLI_NOMBRES); ?>

                            </a>

                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                <?php if(Auth::guard('cliente')->user()->CLI_EMAIL === 'admin@gmail.com'): ?>
                                    <li>
                                        <a href="<?php echo e(route('home')); ?>" class="dropdown-item fw-bold text-primary">
                    ...
                    <li>
                        <a href="<?php echo e(route('shop.cart')); ?>" class="text-dark text-decoration-none" aria-label="Ver carrito de compras">
    ...
    <main id="main-content" tabindex="-1">
        <section class="min-vh-100 d-flex align-items-center justify-content-center hero-section"
                 style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('<?php echo e(asset('img/background.jpg')); ?>') center/cover;">
    ...
    <footer class="u-bg-gray border-top border-2 py-5" role="contentinfo">
        <div class="container text-center text-md-start">
            <p class="mb-0 fw-bold">
                &copy; <?php echo e(date('Y')); ?> Cap & Knit. Todos los derechos reservados.
            </p>
    ...
    <script src="<?php echo e(asset('accessibility.js')); ?>"></script>

</body>
</html><?php /**PATH C:\Users\USUARIO\Herd\cap-knit\resources\views/welcome.blade.php ENDPATH**/ ?>