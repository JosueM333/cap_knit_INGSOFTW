...
<header class="login-header shadow-sm">
    <div class="container d-flex justify-content-center justify-content-md-start">
        <a href="<?php echo e(route('shop.index')); ?>" class="text-dark text-decoration-none fw-bold fs-4 d-flex align-items-center gap-2">
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <button type="button" 
                                            class="toggle-password text-decoration-underline" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 form-check">
                                <input type="checkbox" class="form-check-input border-dark" id="remember-me" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                                <label class="form-check-label small fw-bold" for="remember-me">Recordar mis datos</label>
                            </div>
                        ...
                        <div class="text-center mt-4 pt-3 border-top border-light">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-dark w-100 btn-sm fw-bold">
                                Crear cuenta nueva
                            </a>
                            
                            <div class="mt-4">
                                <a href="<?php echo e(route('shop.index')); ?>" class="text-decoration-none small text-muted fw-bold link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
...
</html><?php /**PATH C:\Users\USUARIO\Herd\cap-knit\resources\views/auth/login.blade.php ENDPATH**/ ?>