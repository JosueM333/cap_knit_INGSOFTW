...
class ComprobanteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($carrito->detalles as $detalle) {
                ...
                // ✅ Leer stock desde BODEGA_PRODUCTO de forma segura en Oracle
                ...
                DB::table('BODEGA_PRODUCTO')
                    ...
                    ->update([
                        'BP_STOCK' => $nuevoStock,
                        'UPDATED_AT' => now(), // porque tu pivote tiene timestamps
                    ]);
            }
    ...
    public function anular(Request $request, $id)
    {
        try {
            ...
            $comprobante->COM_OBSERVACIONES = trim(($comprobante->COM_OBSERVACIONES ?? '') . " | [ANULADO " . now()->format('d/m/Y') . "]: " . $motivo);
            $comprobante->save();
